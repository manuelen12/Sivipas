...
public class ConsultarListaUsuariosFragment extends Fragment implements Response.Listener<JSONObject>,Response.ErrorListener{
    ...
    //Este metodo no lo veo en tu otra clase que hereda Fragment
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {

        //Observa este ejemplo de como se infla la vista desde un fragmento
    ...
    private void cargarWebService() {
        ...
        String url=ip+"/consulta_servicio/consultas/wsJSONConsultarListaLogin.php";
    ...
    public void onResponse(JSONObject response) {
        ...
        try {
            ...
            for (int i=0;i<json.length();i++){
                ...
                usuario.setContrasena(jsonObject.optInt("contrasena"));
